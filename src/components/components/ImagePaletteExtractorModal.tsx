...
const ImagePaletteExtractorModal: React.FC<ImagePaletteExtractorModalProps> = ({ isOpen, onClose, onLoadPalette }) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
        ...
        >
          ...
          >
            <ImagePaletteExtractor onPaletteExtracted={(colors) => { onLoadPalette(colors); onClose(); }} />
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
...
export default ImagePaletteExtractorModal;
